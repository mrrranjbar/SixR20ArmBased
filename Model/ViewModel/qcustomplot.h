...
////  Q_PROPERTY(TrajectoryPointList<double>* desired READ desired WRITE setDesired)
...
//  //added
//  static TrajectoryPointList<double> * Desired;

////  static TrajectoryPointList<double>* desired();
////  static void setDesired(TrajectoryPointList<double> *d);
